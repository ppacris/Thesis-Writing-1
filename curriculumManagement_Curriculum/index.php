...
<section class="container pt-3">
    <div class="row">
        ...
        <div class="col">
            <h3><i class="fa-solid fa-scroll"></i> View Corriculum</h3>
        </div>
            ...
            <div class="row row-cols-2">
                ...
                <div class="col d-flex justify-content-end align-items-center">
                    <button class="btn btn-success">
                        <a href="../cm_c_AddCurriculum/" style="text-decoration: none;" class="text-light">
                            <i class="fa-solid fa-upload"> </i> Add New Curriculum
                        </a></button>
                </div>
            </div>
        </div>
